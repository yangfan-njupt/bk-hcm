...
func (a *accountSvc) GetAccount(cts *rest.Contexts) (interface{}, error) {
	...
	return a.getAccountByVendor(cts, accountID, baseInfo.Vendor)
}

func (a *accountSvc) getAccountByVendor(cts *rest.Contexts, accountID string, vendor enumor.Vendor) (interface{}, error) {
	switch vendor {
	case enumor.TCloud:
...
func (a *accountSvc) getTCloudAccount(cts *rest.Contexts, accountID string) (
	*protocloud.AccountGetResult[cloud.TCloudAccountExtension], error) {
...
func (a *accountSvc) getAwsAccount(cts *rest.Contexts, accountID string) (
	*protocloud.AccountGetResult[cloud.AwsAccountExtension], error) {
...
func (a *accountSvc) getHuaWeiAccount(cts *rest.Contexts, accountID string) (
	*protocloud.AccountGetResult[cloud.HuaWeiAccountExtension], error) {
...
func (a *accountSvc) getGcpAccount(cts *rest.Contexts, accountID string) (
	*protocloud.AccountGetResult[cloud.GcpAccountExtension], error) {
...
func (a *accountSvc) getAzureAccount(cts *rest.Contexts, accountID string) (
	*protocloud.AccountGetResult[cloud.AzureAccountExtension], error) {
